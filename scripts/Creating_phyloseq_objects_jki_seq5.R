...
otu_mat<-read_excel("~/Documents/R_analysis/jki_seq5/data_jki_seq5/jki_seq5_otu.xlsx")
taxo_mat<-read_excel("~/Documents/R_analysis/jki_seq5/data_jki_seq5/jki_seq5_taxa.xlsx")
metadata<-read.csv("~/Documents/R_analysis/jki_seq5/data_jki_seq5/jki_seq5_metadata.csv", row.names = 1)
...
jki_seq5_data<-phyloseq(OTU, TAX, SAMPLE)
...
sample_variables(jki_seq5_data)
