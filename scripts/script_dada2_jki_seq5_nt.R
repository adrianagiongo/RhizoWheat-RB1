...
path <- "~/jki_seq5_nt/jki_seq5/" # change to the right location
list.files(path)
...
pdf("~/jki_seq5_nt/jki_seq5_dada2_output/plot_Quality_Forward.pdf")
plotQualityProfile(fnFs[1:6])
dev.off()

pdf("~/jki_seq5_nt/jki_seq5_dada2_output/plot_Quality_Reverse.pdf")
...
pdf("~/jki_seq5_nt/jki_seq5_dada2_output/Quality_Forward2.pdf")
plotQualityProfile(filtFs[1:6])
dev.off()

pdf("~/jki_seq5_nt/jki_seq5_dada2_output/Quality_Reverse2.pdf")
...
pdf("~/jki_seq5_nt/jki_seq5_dada2_output/plot_error_Forward.pdf")
plotErrors(errF, nominalQ=TRUE)
dev.off()

errR <- learnErrors(filtRs, multithread=TRUE)
pdf("~/jki_seq5_nt/jki_seq5_dada2_output/plot_error_Reverse.pdf")
...
#save.image(file = "~/jki_seq5/jki_seq5_16S/jki_seq5/jki_seq5_dada2_output/JKI_seq5.RData")
#load("~/jki_seq5/jki_seq5_16S/jki_seq5/jki_seq5_dada2_output/JKI_seq5.RData")
...
#Export results
write.csv(seqtab.nochim.t, "~/jki_seq5_nt/jki_seq5_dada2_output/jki_seq5_Phy_Table.csv")
...
write.csv(track, "~/jki_seq5_nt/jki_seq5_dada2_output/jki_seq5_Quality_Control.csv")

saveRDS(seqtab.nochim, file = "~/jki_seq5_nt/seqtab.nochim_jki_seq5.rds")
save.image(file = "~/jki_seq5_nt/jki_seq5_dada2.RData")

#Load workspace or object
#load("~/jki_seq5/jki_seq5_16S/jki_seq5_dada2.RData")
#seqtab.nochim <- readRDS("~/jki_seq5/jki_seq5_16S/seqtab.nochim_jki_seq5.rds")
...
write.csv(taxa, "~/jki_seq5_nt/jki_seq5_dada2_output/jki_seq5_taxa_silva138_table.csv")
...
#write.csv(taxa, "~/jki_seq5/jki_seq5/jki_seq5/jki_seq5_dada2_output/jki_seq5_taxa_species_silva138_table.csv")
