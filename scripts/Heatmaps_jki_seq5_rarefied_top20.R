...
ggsave("heatmap_psO_jki_seq5_rarefied_T1_filt_annotation_rel_top10_taxa.png", path = "~/Documents/R_analysis/jki_seq5/output_jki_seq5/Heatmap_jki_seq5/", width = 28, height = 28, units = "cm",dpi = 300)
...
ggsave("heatmap_psO_jki_seq5_rarefied_T2_filt_annotation_rel_top10_taxa.png", path = "~/Documents/R_analysis/jki_seq5/output_jki_seq5/Heatmap_jki_seq5/", width = 28, height = 28, units = "cm",dpi = 300)
