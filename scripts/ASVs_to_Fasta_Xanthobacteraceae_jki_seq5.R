...
csv_file_sequences <- "~/Documents/R_analysis/jki_seq5/data_jki_seq5/Phylogeny_Xantho/jki_seq5_seqs.csv"  # Path to your CSV file with sequences

# Specify the path to the file containing ASV names to be selected
csv_file_asv_names <- "~/Documents/R_analysis/jki_seq5/data_jki_seq5/Phylogeny_Xantho/Xanthobacteraceae.csv"  # Path to your CSV file with ASV names
