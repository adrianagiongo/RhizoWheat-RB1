...
query_otu_seq   = '~/Documents/R_analysis/jki_seq5/data_jki_seq5/Tax4Fun2/T2_D60_filt.fasta'              # input OTU sequence file
query_otu_table = '~/Documents/R_analysis/jki_seq5/data_jki_seq5/Tax4Fun2/T2_D60_filt.txt'          # input OTU table
pwd_op_folder   = '~/Documents/R_analysis/jki_seq5/output_jki_seq5/Tax4Fun2_jki_seq5/T2_D60'     # output directory
